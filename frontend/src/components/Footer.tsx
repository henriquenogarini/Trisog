...
const Footer: React.FC = () => {
  ...
  const logoFooter = "https://firebasestorage.googleapis.com/v0/b/travelling-c5077.appspot.com/o/Header_Images%2FLogo_Trisog.png?alt=media&token=c0fe5c09-d59c-473a-bd3e-38f7408d0c93"
  const facebook = "https://firebasestorage.googleapis.com/v0/b/travelling-c5077.appspot.com/o/Header_Images%2FFacebook.png?alt=media&token=cc1d8d3a-2f75-41de-969c-c3da9d8a762d"
  const twitter = "https://firebasestorage.googleapis.com/v0/b/travelling-c5077.appspot.com/o/Header_Images%2FTwitter.png?alt=media&token=3112c64b-b199-44d5-b83a-24abf224d02c"
  const linkedin = "https://firebasestorage.googleapis.com/v0/b/travelling-c5077.appspot.com/o/Header_Images%2FLinkedIn.png?alt=media&token=d12fb7a9-43e8-442f-81b5-cf6261f32118"
    ...
    <footer className="footer">
        <div className="footerContainer">
            ...
            <div className="newsletter">
                ...
                <p className="rightReserved">2023 Trisog All Right Reserved</p>
            </div>
        </div>
    </footer>
    </>
